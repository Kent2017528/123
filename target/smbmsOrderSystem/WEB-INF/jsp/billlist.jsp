...
<div class="right">
       ...
       <form method="get" action="${pageContext.request.contextPath }/sys/bill/query">
			...
			<select name="queryIsPayment">
			 ...
			 <a href="${pageContext.request.contextPath }/sys/bill/toadd">添加订单</a>
		</form>
       </div>
       <!--账单表格 样式和供应商公用-->
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${pageInfo.list }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="javascript:;" billid=${bill.id }
							billcc=${bill.billCode }><img src="${pageContext.request.contextPath
							}/statics/images/read.png" alt="查看" title="查看"/></a></span>
...
<script type="text/javascript"
		src="${pageContext.request.contextPath }/statics/js/billlist.js?v="+new Date() ></script>